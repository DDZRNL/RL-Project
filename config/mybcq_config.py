...
class MYBCQConfig(BaseConfig):
    ...
    def algo_config(self):
        ...
        self.algo.optim_params.critic.learning_rate.initial = 0.0015              # critic learning rate
        ...
        self.algo.optim_params.action_sampler.learning_rate.initial = 0.0015      # action sampler learning rate
        ...
        self.algo.optim_params.actor.learning_rate.initial = 0.0015               # actor learning rate
        ...
        self.algo.discount = 0.92                           # discount factor to use
