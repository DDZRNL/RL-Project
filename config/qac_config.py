"""
Config for QAC algorithm.
"""

from robomimic.config.base_config import BaseConfig


class QACConfig(BaseConfig):
    ALGO_NAME = "qac"
    ...
    def train_config(self):
        ...
        """
        super(QACConfig, self).train_config()
    ...
    def algo_config(self):
        ...
        self.algo.critic.qac_weight = 1.0                                   # weighting for cql component of critic loss (only used if target_q_gap is < 0 or None)
